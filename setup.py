...
setup(
    name='aflux_assurance_client',
    version='0.1.0',
    description="A short description of the project.",
    long_description=readme + '\n\n' + history,
    author="Mark",
    author_email='usrxxx@tdstelecom.com',
    url='https://wiki.tds.net/display/admnetapps/aflux-assurance-client',
    packages=[
        'aflux_assurance_client',
    ],
    package_dir={'aflux_assurance_client':
                 'aflux_assurance_client'},
    include_package_data=True,
    install_requires=requirements,
    entry_points={
        'console_scripts': [
            'aflux_assurance_client=aflux_assurance_client.main:main', # You will want to update this
        ],
    },
    license="ISCL",
    zip_safe=False,
    keywords='aflux_assurance_client',
    classifiers=[
